...
class TestAuthentication(unittest.TestCase):
    ...
    def test_user_log_out(self):
        ...
        self.wait.until(EC.presence_of_element_located((By.LINK_TEXT, "Log Out"))).click()

        # Verify we're back on the home page and logged out
        self.wait.until(EC.url_matches("/"))
        self.assertIn("Home", self.driver.title)
        self.assertIn("/", self.driver.current_url)
        self.assertTrue(self.driver.find_element(By.LINK_TEXT, "Log In").is_displayed())
